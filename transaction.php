...
<head>
    ...
    <title>Transaction - Seniorita Laundry Care</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion p-0 toggled" style="background: var(--bs-primary-text-emphasis);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="index.php">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Seniorita<br>Laundry<br>Care</span></div>
                </a>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span class="total">₱<?= number_format($total_laundry, 2)?></span></div>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                                <button class="btn btn-primary btn-sm mb-1 mt-3 <?php if ($fullname == 'NONE') {echo 'd-none';}?>" type="button" data-bs-target="#laundry-add" data-bs-toggle="modal"><i class="fas fa-truck-loading fa-sm text-white-50"></i>&nbsp;Add Laundry</button> 
                            </div>
                            <div class="card shadow <?php if ($fullname == 'NONE') {echo 'd-none';}?>">
                                <div class="card-header py-3">
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © ecodev&nbsp;2023</span></div>
                </div>
            </footer>
                            ...
                            <div class="col">
                                ...
                                <select id="type" class="form-select" name="type">
                                    <optgroup label="SELECT">
                                        ...
                                        <optgroup label="BEDDINGS">
                                            <?php beddings_price_list() ?>
                                        </optgroup>
                                        <optgroup label="COMFORTERS">
                                            <?php comforters_price_list() ?>
                                        </optgroup>
                                        <optgroup label="MAONG">
                                            <?php maong_price_list() ?>
                                        </optgroup>
                                        <optgroup label="REGULAR">
                                            <?php regular_price_list() ?>
                                        </optgroup>
                                        <optgroup label="TOWELS">
                                            <?php towel_price_list() ?>
                                        </optgroup>
                                        <optgroup label="WHITES">
                                            <?php whites_price_list() ?>
                                        </optgroup>
                                        <!-- <?php fold_price_list() ?> -->
                                    </optgroup>
                                </select>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3"><label class="form-label" for="amount"><strong>Amount</strong></label><input class="form-control" type="number" placeholder="Amount" name="amount" value="<?=$total_laundry?>" min="<?=$total_laundry?>" required></div>
                </div>
