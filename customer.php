...
<head>
    ...
    <title>Customer - Seniorita Laundry Care</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Customer Management</h3><button class="btn btn-primary btn-sm mt-3" type="button" data-bs-target="#add" data-bs-toggle="modal"><i class="fas fa-user-check fa-sm text-white-50"></i>&nbsp;Create Customer</button>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/update-customer.php" method="post">
                        ...
                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Address</strong></label><input class="form-control" type="text" placeholder="Address" name="address" required=""></div>
                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Contact</strong>&nbsp;No.</label><input class="form-control" type="text" placeholder="Contact No." name="contact" minlength="12" maxlength="12"></div>
