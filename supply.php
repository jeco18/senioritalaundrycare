...
<head>
    ...
    <title>Supply - Seniorita Laundry Care</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Supply Management</h3><button class="btn btn-primary btn-sm mt-3" type="button" data-bs-target="#add" data-bs-toggle="modal"><i class="fas fa-truck-loading fa-sm text-white-50"></i>&nbsp;Add Item</button>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/add-supply.php" method="post">
                        ...
                        <div class="mb-3"><label class="form-label"><strong>Item Price</strong></label><input class="form-control" type="number" name="price" placeholder="Price" required=""></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/update-supply.php" method="post">
                        ...
                        <div class="mb-3"><label class="form-label"><strong>Item Name</strong></label><input class="form-control" type="text" name="name" placeholder="Name" required=""></div>
                        <div class="mb-3"><label class="form-label"><strong>Item Price</strong></label><input class="form-control" type="text" name="price" placeholder="Price" required=""></div>
                </div>
                <div class="modal-footer"><button class="btn btn-primary" type="submit">Save</button></div>
                </form>
            </div>
