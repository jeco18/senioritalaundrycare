...
<head>
    ...
    <title>Staff - Seniorita Laundry care</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Staff Management</h3><button class="btn btn-primary btn-sm mt-3" type="button" data-bs-target="#add" data-bs-toggle="modal"><i class="fas fa-user-check fa-sm text-white-50"></i>&nbsp;Create Staff</button>
                    </div>
